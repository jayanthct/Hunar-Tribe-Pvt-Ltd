...
const ImpactSection = () => {
  const numbers = ["2,65,000+", "5,000+", "70,000+", "5,000+", "15,000+", "30+"];
  const quantity = ["Kgs", "Students", "Kgs", "Students", "Kgs", "Tribal Youth"];
  const highlight = ["Scrap", "Educational", "Scrap", "Educational", "Plastics", "Skilled"];
  const description = ["Tires Upcycled", "Activities", "Iron Upcycled", "Activities", "Upcycled", "& Empowered"];
