...
const Contactus = () => {
  return (
    ...
    >
      <div className="text-center flex justify-center items-center flex-col gap-0 lg:gap-2">
        <h1 className="text-[48px] tracking-tighter text-textprimary font-medium leading-[120%]">
